...
import cv2
path='/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mtcv/zhuyan29/UCF-101'
# now_frame_action=[i for i in sorted(os.listdir('/opt/kinetics400_frames'))]
savepath='/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mtcv/zhuyan29/UCF_101_frame_org'
