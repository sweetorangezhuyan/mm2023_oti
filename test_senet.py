...
from modules.video_senet import video_header, VideoCLIP
...
def main(args):
    ...
    model_full = VideoCLIP(clip_model,config.data.num_segments)#Video_CSwin(cswin_model, video_head, config.data.num_segments,norm_dim)
    '''
    参数加载
    args.weights：参数
    '''
